...
QT.network.enabled_features = dnslookup ftp localserver networkdiskcache networkproxy socks5 udpsocket
QT.network.disabled_features = bearermanagement dtls gssapi http networkinterface opensslv11 ocsp schannel sctp securetransport ssl sspi
QT_CONFIG += ftp localserver networkdiskcache networkproxy socks5 udpsocket
QT_MODULES += network
